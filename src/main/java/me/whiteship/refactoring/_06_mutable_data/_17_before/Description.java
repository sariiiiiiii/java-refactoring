package me.whiteship.refactoring._06_mutable_data._17_before;
...
public class Description {
     ...
     *   - "질의 함수와 변경 함수 분리하기 (Separate Query from Modifier)"를 적용해서 클라이언트가 원하는 경우에만 사이드 이팩트가 있는 함수를
     *     호출하도록 API를 개선할 수 있다
     ...
     *   - 변수가 사용되는 범위를 제한하려면 "여러 함수 클래스로 묶기 (Combine Functions into Class)" 또는
     *     "여러 함수를 변환 함수로 변경(Combine Functions into Transform)"을 적용할 수 있다
